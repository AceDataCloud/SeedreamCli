# Copilot Instructions for SeedreamCli
...
2. **Compare parameters** — CLI command parameters in `seedream_cli/commands/` should match the corresponding OpenAPI endpoint's request body schema.
...
4. **Update client** — If API endpoints change, update `seedream_cli/core/client.py` accordingly.
